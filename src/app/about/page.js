          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600">
                Today, we are proud to serve thousands of satisfied customers and continue to grow our business while maintaining the personal touch that makes us special.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg p-8 shadow-md">
              ...
              <p className="text-gray-600 text-center">
                We are proud to be part of our local community and support local businesses.
              </p>
            </div>
            <div className="bg-white rounded-lg p-8 shadow-md">
              <div className="w-16 h-16 bg-green-600 rounded-full flex items-center justify-center mx-auto mb-6">
